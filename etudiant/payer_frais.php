                            ...
                            <div class="frais-list payes">
                                <?php foreach ($frais_payes as $frais): ?>
                                    <div class="frais-item-paiement frais-deja-paye">
                                        <div class="frais-item-header">
                                            <h5><?= htmlspecialchars($frais['type_frais']) ?></h5><span class="badge-paye-sm">Payé le <?= date('d/m/Y', strtotime($frais['date_paiement'])) ?></span>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (tel) tel.addEventListener('input', function() {
                ...
                if (t.length >= 9) {
                    ...
                    else if (['80', '81', '82', '83', '86', '90', '91'].includes(p)) o = 'Vodacom M-Pesa';
                }
