...
<head>
    ...
    <title>Dashboard Étudiant - ISTAM Paiement</title>
            ...
            <main class="dashboard-content">
                ...
                <div class="progression-card">
                    ...
                    <div class="progression-footer">
                        <span>Total à payer : <strong>$<?= number_format($total_a_payer, 2) ?></strong></span>
                        <span>Payé : <strong class="text-success">$<?= number_format($total_paye, 2) ?></strong></span>
                        <span>Reste : <strong class="text-warning">$<?= number_format($reste_a_payer, 2) ?></strong></span>
                    </div>
                    <div class="progression-detail">
                        <span><i class="fas fa-check-circle text-success"></i> <?= $nb_frais_payes ?> frais payés</span>
                ...
                <div class="frais-section">
                    <div class="section-header">
                        <h3><i class="fas fa-list-alt"></i> Mes Frais Académiques</h3>
                    ...
                    <?php if (empty($frais_a_payer)): ?>
                        <div class="empty-state">
                            ...
                            <h4 class="mt-3">Aucun frais configuré</h4>
                            <p>Aucun frais n'a été configuré pour votre filière et promotion. Veuillez contacter le secrétariat.</p>
                        </div>
                    <?php else: ?>
                            ...
                            ?>
                                <div class="frais-card <?= $est_paye ? 'frais-paye' : 'frais-a-payer' ?>">
                                    <div class="frais-card-status">
                                        <?php if ($est_paye): ?>
                                            <span class="badge-paye"><i class="fas fa-check-circle"></i> Payé</span>
                                        <?php else: ?>
                                            <span class="badge-a-payer"><i class="fas fa-clock"></i> À payer</span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if ($est_paye): ?>
                                        <div class="frais-paye-info">
                                            <small>Payé le <?= date('d/m/Y', strtotime($frais['date_paiement'])) ?></small>
                                        </div>
                                    <?php else: ?>
                ...
                <div class="charts-grid-etu">
                    ...
                    <div class="chart-card-etu">
                        <div class="chart-card-header">
                            <h4><i class="fas fa-chart-pie"></i> Répartition de mes paiements</h4>
                        </div>
                ...
                <div class="chart-card-etu chart-full mt-3">
                    <div class="chart-card-header">
                        <h4><i class="fas fa-chart-line"></i> Évolution mensuelle de mes paiements</h4>
                    </div>
                    <div class="chart-card-body">
