...
function getNotifIconEtu($message) {
    ...
    } elseif (strpos($msg, 'succès') !== false || strpos($msg, 'réussi') !== false || strpos($msg, 'confirmé') !== false) {
        return ['icon' => 'fa-check-circle', 'color' => 'icon-green'];
    } elseif (strpos($msg, 'échec') !== false || strpos($msg, 'erreur') !== false || strpos($msg, 'rejeté') !== false) {
    ...
    } elseif (strpos($msg, 'reçu') !== false || strpos($msg, 'bordereau') !== false || strpos($msg, 'pdf') !== false) {
...
<head>
    ...
    <title>Notifications - Étudiant ISTAM</title>
                        ...
                        <?php if (empty($notifications)): ?>
                            <div class="notif-empty-etu">
                                ...
                                <p class="text-muted">
                                    ...
                                    <?php else: ?>
                                        Vous recevrez des notifications pour vos paiements et reçus.
                                    <?php endif; ?>
                                </p>
                            </div>
                        <?php else: ?>
