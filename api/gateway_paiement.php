...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-menu">
        <ul class="menu-list">
            ...
            <li class="menu-label"><span>STRUCTURE ACADÃ‰MIQUE</span></li>
            ...
            <li class="menu-item">
                <a href="gestion_utilisateurs.php" class="menu-link <?= $current === 'gestion_utilisateurs.php' ? 'active' : '' ?>">
                    ...
                    <span>Personnel</span>
                    <small class="menu-badge">Admin & SecrÃ©taires</small>
            ...
            <!-- ========== SYSTÃˆME ========== -->
            <li class="menu-label"><span>SYSTÃˆME</span></li>
